              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Кнопка</label>
                    <div class="row">
                      <div class="col-md-6"><input class="form-control" name="button_text" placeholder="Текст"
                          type="text"></div>
                      <div class="col-md-6"><input class="form-control" name="button_href" placeholder="Ссылка"
                          type="text"></div>
                    </div>
                  </div>
                </div>
